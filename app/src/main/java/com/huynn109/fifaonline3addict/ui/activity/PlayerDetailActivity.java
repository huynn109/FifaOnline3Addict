...
public class PlayerDetailActivity extends RxAppCompatActivity {
    ...
    @BindView(R.id.image_avatar_player)
    CircleImageView imageAvatarPlayer;
    @BindView(R.id.text_season)
    TextView textSeason;
    @BindView(R.id.image_season_wb)
    ImageView imageSeasonWb;
    @BindView(R.id.image_season_wl)
    ImageView imageSeasonWl;
    @BindView(R.id.image_season)
    ImageView imageSeason;
    @BindView(R.id.text_name)
    TextView textName;
    @BindView(R.id.text_view_roster_update)
    TextView textViewRosterUpdate;
    @BindView(R.id.text_view_live_boost)
    TextView textViewLiveBoost;
    @BindView(R.id.linear_title)
    LinearLayout linearTitle;
    @BindView(R.id.text_foot_left)
    TextView textFootLeft;
    @BindView(R.id.text_foot_right)
    TextView textFootRight;
    @BindView(R.id.linear_foot)
    LinearLayout linearFoot;
    @BindView(R.id.linear_top_layer)
    RelativeLayout linearTopLayer;
    ...
    @BindView(R.id.text_view_position_1_name)
    TextView textViewPosition1Name;
    @BindView(R.id.text_view_position_1_value)
    TextView textViewPosition1Value;
    @BindView(R.id.linear_1)
    LinearLayout linear1;
    @BindView(R.id.text_view_position_2_name)
    TextView textViewPosition2Name;
    @BindView(R.id.text_view_position_2_value)
    TextView textViewPosition2Value;
    @BindView(R.id.linear_2)
    LinearLayout linear2;
    @BindView(R.id.text_view_position_3_name)
    TextView textViewPosition3Name;
    @BindView(R.id.text_view_position_3_value)
    TextView textViewPosition3Value;
    @BindView(R.id.linear_3)
    LinearLayout linear3;
    @BindView(R.id.text_view_position_4_name)
    TextView textViewPosition4Name;
    @BindView(R.id.text_view_position_4_value)
    TextView textViewPosition4Value;
    ...
    TextView textAttack;
    @BindView(R.id.text_defence)
    TextView textDefence;
    ...
    TextView textClub;
    @BindView(R.id.image_logo_club)
    ImageView imageLogoClub;
    ...
    DachshundTabLayout tabStat;
    @BindView(R.id.app_bar)
    AppBarLayout appBar;
    @BindView(R.id.view_pager_stat)
    ViewPager viewPagerStat;
    @BindView(R.id.ad_player_detail)
    AdView adPlayerDetail;
        ...
        if (elementStat != null) {
            ...
            if (elementTrait != null) {
                ...
                for (Element element : elementTrait) {
                    int positionTrait = Integer.valueOf(
                            element.select("a").attr("href").split("inTraits=")[1]);
                    if (positionTrait != 0) {
